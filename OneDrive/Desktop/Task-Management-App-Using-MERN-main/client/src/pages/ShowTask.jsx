            ...
            {apiData && apiData.status ?
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-5">
                        ...
                        <select onChange={handleInput} name="status" value={formData?.status || 'Pending'}
                            className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div className="mb-5">
                        ...
                        <input type="date" name="dueDate" value={formData?.dueDate ? formData.dueDate.split('T')[0] : ''}
                            onChange={handleInput}
                            className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        />
                        {err && err.dueDate && <span className="text-red-500 text-sm">{err.dueDate}</span>}
                    </div>
